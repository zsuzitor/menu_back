...
namespace PlaningPoker.Models
{
    public class Constants
    {
        ...
        public static class Loggers
        {
            ...
            public const string PlaningPoker = "PlaningPoker";
        }
        ...
        public class PlaningPokerErrorConsts
        {
            public const string RoomNameIsEmpty = "planing_poker_room_name_is_empty";
            public const string PlaningUserNotFound = "planing_poker_planing_user_not_found";
