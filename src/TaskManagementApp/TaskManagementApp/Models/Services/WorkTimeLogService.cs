...
namespace TaskManagementApp.Models.Services
{
    public class WorkTimeLogService : IWorkTimeLogService
    {
        ...
        {
            var time = await _workTimeLogRepository.GetTimeAccessEditAsync(id, userId);
        ...
        public async Task<WorkTimeLog> EditAsync(WorkTimeLog obj, long userId)
        {
            ...
            var time = await _workTimeLogRepository.GetTimeAccessEditAsync(obj.Id, userId);
        ...
        {
            return await _workTimeLogRepository.GetTimeForUserAsync(userId.Value, startDate, endDate);
        }
