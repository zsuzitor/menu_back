...
{
    public class CreateEventWithdrawalCash : CreateEventBase
    {
        public CreateEventWithdrawalCash(long userId, IStockRepository stockRepository, IDateTimeProvider datetimProvider,
        ...
        protected override  StockEventEnum Type => StockEventEnum.WithdrawalCash;
        ...
        protected override async Task<StockElement> GetStockElement(StockEventCreate obj)
        {
            ...
            if (currencyElement == null)
            {
                var elem = new StockElement()
                {
                    ...
                    Count = obj.CurrencyActions ?  -1 * obj.Count:0,
            ...
            {
                currencyElement.Count += obj.CurrencyActions ?  -1 * obj.Count:0;
            }
