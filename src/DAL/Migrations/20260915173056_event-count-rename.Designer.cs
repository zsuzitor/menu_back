...
namespace DAL.Migrations
{
    ...
    [Migration("20260915173056_event-count-rename")]
    partial class eventcountrename
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BO.Models.FinancialAssistant.DAL.StockEvent", b =>
                {
                    ...
                    b.Property<decimal>("CountChange")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CountNow")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<long>("StockElementId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BO.Models.FinancialAssistant.DAL.StockEvent", b =>
                {
                    ...
                    b.HasOne("BO.Models.FinancialAssistant.DAL.StockElement", "StockElement")
                        .WithMany("Events")
                        .HasForeignKey("StockElementId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
